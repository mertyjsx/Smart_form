...
if(!universty.u_to){
  ...
  field_array.push({value:field,id:Math.floor(Math.random() * Math.floor(10000))})
  ...
  course_array.push({value:course,id:Math.floor(Math.random() * Math.floor(10000))})
  ...
  award_array.push({value:award,id:Math.floor(Math.random() * Math.floor(10000))})
  ...
  const addhonor = (e) => {
    ...
    honor_array.push({value:honor,id:Math.floor(Math.random() * Math.floor(10000))})
